...
# ----------------------------------------------------------
# PLOTTING FUNCTION (smaller text, longer arrows, custom HCC6)
# ----------------------------------------------------------
plot_hcc_final <- function(data, sex_label) {
  ...
  # Get value for HCC6 for manual label
  ...
  ggplot() +
    ...
    # Custom "HCC 6" leader line & label
    geom_curve(
      aes(
        x = -64.95, y = 47.35,  # start (roughly center of HCC6)
        xend = -64.5, yend = 47.9  # end (point for label)
      ),
      curvature = -0.2,
      color = "black",
      linewidth = 0.6,
