...
plot_hcc_final <- function(data, sex_label) {
  ...
  centroids <- centroids %>%
    ...
    mutate(
      ...
      label_x = case_when(
        ...
        com == 14.3 ~ X + 0.42,
        com == 22.1 ~ X + 2.3,
        com == 11 ~ X - 0.05,    # slight right shift
  ...
  ggplot() +
    ...
    # Labels (slightly transparent white background)
    geom_label(
      data = centroids,
